...
def load(filename, normalized=True, channels=3):
    ...
    :param normalized: boolean. If True, dct coefficients are normalized with
        quantification tables. If False, no normalization is performed.
    ...
    :note: given an image of size 512 x 512 x 64, the dct_y will be 64 x 64 x 64 and
